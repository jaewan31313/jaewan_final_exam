...
my_string_input = get_english_input("Enter the main string: ")
target_input = get_english_input("Enter the target substring: ")


result = solution(my_string_input, target_input)
print(result)  # 결과 출력
